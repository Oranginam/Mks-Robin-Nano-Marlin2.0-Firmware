...
#define STRING_CONFIG_H_AUTHOR "(ORANGINAM, OR-1 (LVGL V1))" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "OR-1"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //24V Bed
  #define DEFAULT_bedKp 94.03
  #define DEFAULT_bedKi 17.00
  #define DEFAULT_bedKd 346.71
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 401, 405 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 300, 300, 100, 3000 }

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 600, 600, 200, 6000 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 20, -27, -2.34 }
...
#define HOMING_FEEDRATE_MM_M { (40*60), (10*60), (4*60) }
